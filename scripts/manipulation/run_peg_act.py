"""ACT on the keyed-peg insertion demonstrations, the released
...
Run,
  python scripts/manipulation/run_peg_act.py --demos outputs/peg/demos/expert_episodes.pt \
      --out_dir outputs/peg/act --epochs 2000
"""
...
parser.add_argument("--out_dir", type=str, default="outputs/peg/act")
...
parser.add_argument("--tag", type=str, default="peg")
