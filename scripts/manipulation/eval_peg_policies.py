...
Run,
  python scripts/manipulation/eval_peg_policies.py --actors expert act \
      --act_ckpt outputs/peg/act/act_peg.pt \
...
parser.add_argument("--act_ckpt", type=str, default="outputs/peg/act/act_peg.pt")
