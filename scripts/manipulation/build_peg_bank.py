"""Build the pregrasp and grasp bank of the keyed-peg insertion cuboid
...
Run,
  python scripts/manipulation/build_peg_bank.py \
...
parser.add_argument("--out", type=str, default="assets/peg_insert_bank.json")
