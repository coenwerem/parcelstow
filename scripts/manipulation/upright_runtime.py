"""Shared runtime pieces of the upright placement drivers: the phase
...
import torch
import upright_place_expert as upe
...
def config_stamp(base, task_id="UprightPlace-L6-Play-v0"):
    return {
        "git_sha": rt.git_sha(),
        "task": task_id,
