"""ACT on the upright placement demonstrations, the released
run_stow_act.py configuration unchanged (state-only DETRVAE, chunk 100,
...
Run,
  python scripts/manipulation/run_upright_act.py --demos outputs/upright/demos/expert_episodes.pt \
      --out_dir outputs/upright/act --epochs 2000
"""
...
parser.add_argument("--out_dir", type=str, default="outputs/upright/act")
...
parser.add_argument("--tag", type=str, default="upright")
