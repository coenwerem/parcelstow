...
<table align="center">
  <tr>
    <td align="center" valign="top" width="33%">
      ...
      <br>
      <sub><b>Parcel Insertion.</b> Acquire and reorient a parcel, then insert it into an open-front receptacle. Click to play the full video on Hugging Face.</sub>
    </td>
    <td align="center" valign="top" width="33%">
      ...
      <br>
      <sub><b>Upright Placement.</b> Reorient a cuboid to an upright pose and release it in a target region. Click to play the full video on Hugging Face.</sub>
    </td>
    <td align="center" valign="top" width="33%">
      ...
      <br>
      <sub><b>Keyed Peg Insertion.</b> Reorient a cuboid and insert it into a square pocket with 3 mm of clearance per side. Click to play the full video on Hugging Face.</sub>
    </td>
  </tr>
</table>
